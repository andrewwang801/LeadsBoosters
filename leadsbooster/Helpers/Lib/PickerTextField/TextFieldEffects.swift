...
public class TextFieldEffects : UITextField {
    ...
    override public func willMove(toSuperview newSuperview: UIView!) {
        if newSuperview != nil {
            NotificationCenter.default.addObserver(self, selector: #selector(textFieldDidEndEditing(_:)), name: UITextField.textDidEndEditingNotification, object: self)
            
            NotificationCenter.default.addObserver(self, selector: #selector(textFieldDidBeginEditing(_:)), name: UITextField.textDidBeginEditingNotification, object: self)
        } else {
     ...
     */
    @objc public func textFieldDidBeginEditing(_ notification:Notification) {
        animateViewsForTextEntry()
    }
     ...
     */
    @objc public func textFieldDidEndEditing(_ notification:Notification) {
        animateViewsForTextDisplay()
    }
